...
import vn.edu.usth.threadit.activity.PostDetailsActivity;
import vn.edu.usth.threadit.activity.PostLikedByActivity;
        ...
        liekeref.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                if (dataSnapshot.child(pid).hasChild(myuid)) {
                    holder.likebtn.setText("Upvoted");
                } else {
                    holder.likebtn.setText("Upvote");
                }
            }
